 ...
 *
 *   +1.00 on every song, set by ear. All four read early by about the same
...
const PACKS = [
  {
    ...
    id: "viva-la-vida", title: "Viva La Vida", artist: "Coldplay", offsetSec: -4.95, lyricLeadSec: 1.0,
    phrases: [
  ...
  {
    id: "creep", title: "Creep", artist: "Radiohead", offsetSec: 3.9, lyricLeadSec: 1.0,
    phrases: [
  ...
  {
    id: "perfect", title: "Perfect", artist: "Ed Sheeran", offsetSec: 3.88, lyricLeadSec: 1.0,
    phrases: [
  ...
  {
    id: "im-not-the-only-one", title: "I'm Not The Only One", artist: "Sam Smith", offsetSec: -4.62, lyricLeadSec: 1.0,
    phrases: [
